...
static const int MAX_SPEECH_LENGTH = 50;
...
static const char ASK_PROGRAM_MODE[] = "I don't know, which program mode you want to use. Can you say me? [G/D/C]";

//----------------------------------------------------------------------------------------------------------------
//GREETING
//----------------------------------------------------------------------------------------------------------------

static const char GREETINGS[NUMBER_OF_GREETINGS_PARTS][MAX_SPEECH_LENGTH] = 
{
...
static const char FAREWELLS[NUMBER_OF_FAREWELLS_PARTS][MAX_SPEECH_LENGTH] = 
{
